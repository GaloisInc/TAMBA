...
let query_to_string query_name params : string option =
  ...
  let param_to_json (name, value) =
    ...
    | "ship_lat" -> (name, `Int (int_of_float (float_of_string value *. 10.0)))
    | "ship_long" -> (name, `Int (int_of_float (float_of_string value *. 10.0)))
    | "port_lat" -> (name, `Int (int_of_float (float_of_string value *. 10.0)))
    | "port_long" -> (name, `Int (int_of_float (float_of_string value *. 10.0)))
